...
if(isset($_SESSION['roman'])){
	$roman = $_SESSION['roman'];
}else{
	$roman = 71;
}
$_SESSION['roman'] = $roman + 1;
if($_SESSION['roman'] > 78){
	$_SESSION['roman'] = 71;
}
?>
<!DOCTYPE html>
...
<?php
	...
	$week = $date->format("M");
	$id = json_encode($roman);
	$con=mysqli_connect("localhost","root","","software_project");
	$query = "SELECT * FROM docofplay WHERE Subject = 'Poem' AND Id = '$id'";
...
vid.onended = function() {
  window.location.href='game_no_2.php';
};
</script>
