...
<?php
	...
	$week = $date->format("M");
	$id = json_encode($counter);
	$con=mysqli_connect("localhost","root","","software_project");
	$query = "SELECT * FROM docofplay WHERE Subject = 'English' AND Id = '$id'";
...
<div class="container">
  <div class="sidenav">
  <img src=<?php echo $img; ?> class="img-circle" alt="Cinque Terre" width="224" height="236"> 
</div>
<div class="main">
...
vid.onended = function() {
  window.location.href='game_no_1.php';
};
</script>
